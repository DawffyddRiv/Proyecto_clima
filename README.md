...
cantidad de datos que se requiera almacenar, por ello la acción de emplear rutas(donde almacenan csv) para ser introducidas como parámetros en lugar de dataframes.
